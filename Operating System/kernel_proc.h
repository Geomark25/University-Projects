...
/////////////////////////////////////////////
  rlnode ptcb_list;       /// prosthetoyme thn domh toy ptcb 
//////////////////////////////////////////////
...
//////////////////////////////////////////////
  int thread_count;      ///Metraei ta thread otan kaleitai h sys_exec
////////////////////////////////////////////////
  FCB* FIDT[MAX_FILEID];  /**< @brief The fileid table of the process */

} PCB;

////dilonoyme to ptcb . H arxikopoihsh ginete sto thread.c 
////Egine me bash ton kvdika toy procces_thread_block
typedef struct process_thread_control_block {

  int exitval;            /**< @brief The exit value of the process */

  TCB *tcb;               /**< @brief The main thread */
  Task ptcb_task;         /**< @brief The main thread's function */
  int argl;               /**< @brief The main thread's argument length */
  void* args;             /**< @brief The main thread's argument string */
  int exited;
  int detached;
  ...
  /////////////////////////////////////////////////////////
  rlnode ptcb_list_node;  /**< @brief Intrusive node for @c exited_list */

  CondVar exit_cv;        /**< @brief Condition variable for @c WaitChild.*/ 
  
  int refcount;           ///Xrisimopoieitai sthn Thread_Join 
                          ///gia na doyme posa nimata perimenoyn
