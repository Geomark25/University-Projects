...
architecture Behavioral of RAM is
    ...
    signal mux4mux_save: std_logic_vector(31 downto 0);
    signal muxmem: std_logic_vector(31 downto 0);
...
begin
    ...
    mux4_inst_save_byte: MUX4
    port map(
        Din0 => MEM_DataIn(7 downto 0),
        Din1 => MEM_DataIn(15 downto 8),
        Din2 => MEM_DataIn(23 downto 16),
        Din3 => MEM_DataIn(31 downto 24),
        sel => ALU_MEM_Addr(1 downto 0),
        output => mux4mux_save
    );
    
    mux2_inst_save_byte: MUX2
    port map(
        Din0 => MEM_DataIn,
        Din1 => mux4mux_save,
        sel => Byte_sel,
